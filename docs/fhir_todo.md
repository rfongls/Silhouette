...
- [x] Map **MDM** add/update to **DocumentReference** (+ **Binary**).
...
- [x] Map **DFT/BAR** to **ChargeItem** (+ **Account**; optional **Claim** for payer flows).
...
- [x] Handle **A02/A03/A08/A11/A13** Encounter state updates; **A40** merges.
